...
module Tooltip = struct
  ...
  let view (local_ graph) =
    ...
    [%demo
      hbox
        [ View.text
            ~attrs:[ View.tooltip_attr theme "I am a tooltip!" ]
  ...
  let view (local_ graph) =
    ...
    [%demo
      let tooltip position alignment =
        View.tooltip_attr theme ~position ~alignment "Hi, I am a tooltip"
      in
      vbox
        [ hbox
            [ View.text ~attrs:[ tooltip Top Start ] "Top, start"
            ; View.text ~attrs:[ tooltip Top Center ] "Top, center"
            ; View.text ~attrs:[ tooltip Top End ] "Top, end"
            ]
        ; hbox
            [ View.text ~attrs:[ tooltip Bottom Start ] "Bottom, start"
            ; View.text ~attrs:[ tooltip Bottom Center ] "Bottom, center"
            ; View.text ~attrs:[ tooltip Bottom End ] "Bottom, end"
            ]
        ; hbox
            [ View.text ~attrs:[ tooltip Left Start ] "Left, start"
            ; View.text ~attrs:[ tooltip Left Center ] "Left, center"
            ; View.text ~attrs:[ tooltip Left End ] "Left, end"
            ]
        ; hbox
            [ View.text ~attrs:[ tooltip Right Start ] "Right, start"
            ; View.text ~attrs:[ tooltip Right Center ] "Right, center"
            ; View.text ~attrs:[ tooltip Right End ] "Right, end"
            ]
        ]]
  ;;
...
module Tooltip_with_arbitrary_content = struct
  ...
  let view (local_ graph) =
    ...
    [%demo
      ...
      in
      View.text ~attrs:[ tooltip ] "cursed knowledge"]
  ;;
...
module Tooltip_directions_wrap = struct
...
module Tooltip_with_arbitrary_content_wrap = struct
  let name = "Tooltips with arbitrary content"
...
let component (local_ graph) =
  ...
  View.Theme.set_for_app
    ...
    (Gallery.make_sections
       ...
       ; ( "Tooltip (wrap api)"
         , {|There's also a `Vdom.Node.t -> Vdom.Node.t`, "wrap"-based API for tooltips.|}
         , [ Gallery.make_demo (module Tooltip_wrap)
           ; Gallery.make_demo (module Tooltip_directions_wrap)
           ; Gallery.make_demo (module Tooltip_with_arbitrary_content_wrap)
           ] )
       ; ( "Buttons"
         , {| |}
