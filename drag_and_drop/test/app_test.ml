    ...
    <div data-dnd-name="board" class="kanban_container_hash_replaced_in_test" dnd-test-hook=<fun>>
      <div data-drag-targetbonsai_path_replaced_in_test="Todo"
        ...
        <div>
          <div @key=0
               ...
               @on_pointerdown> todo 1 </div>
          <div @key=1
               class="kanban_item_hash_replaced_in_test no_select_hash_replaced_in_test"
               @on_pointerdown> todo 2 </div>
        </div>
      </div>
      <div data-drag-targetbonsai_path_replaced_in_test="In_progress"
        ...
        <div>
          <div @key=2
               class="kanban_item_hash_replaced_in_test no_select_hash_replaced_in_test"
               @on_pointerdown> in progress 1 </div>
          <div @key=3
               class="kanban_item_hash_replaced_in_test no_select_hash_replaced_in_test"
               @on_pointerdown> in progress 2 </div>
          <div @key=4
               class="kanban_item_hash_replaced_in_test no_select_hash_replaced_in_test"
               @on_pointerdown> in progress 3 </div>
        </div>
      </div>
      <div data-drag-targetbonsai_path_replaced_in_test="Finished"
        ...
        <div>
          <div @key=5
               class="kanban_item_hash_replaced_in_test no_select_hash_replaced_in_test"
               @on_pointerdown> finished 1 </div>
          <div @key=6
               class="kanban_item_hash_replaced_in_test no_select_hash_replaced_in_test"
               @on_pointerdown> finished 2 </div>
          <div @key=7
               class="kanban_item_hash_replaced_in_test no_select_hash_replaced_in_test"
               @on_pointerdown> finished 3 </div>
        </div>
      </div>
    </div>
    |}];
